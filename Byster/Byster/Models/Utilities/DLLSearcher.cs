...
namespace Byster.Models.Utilities
{
    public class DLLSearcher
    {
        ...
        public static List<string> EnumProcessModules(uint procIDDDDDDDDDDDDD)
        {
        ...
        public static bool FindModuleInProcess(uint processID, string nameOfModule)
        {
            List<string> processModules = EnumProcessModules(processID);
            if (processModules == null) return false;
            return processModules.Contains(nameOfModule);
        }
    }
}
